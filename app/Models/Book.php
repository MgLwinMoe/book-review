...
class Book extends Model
{
    ...
    public function scopeHightesRatedLastMonth(Builder $query) : Builder | QueryBuilder
    {
        return $query->highestRated(now()->subMonth(), now())->popular(now()->subMonth(), now())->minReviews(2);
    }
    public function scopeHightesRatedLast6Months(Builder $query) : Builder | QueryBuilder
    {
